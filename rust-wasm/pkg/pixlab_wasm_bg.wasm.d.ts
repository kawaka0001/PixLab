...
export const apply_grayscale: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const apply_blur: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
export const apply_brightness: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
export const apply_flip_horizontal: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const apply_flip_vertical: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const apply_rotate_90_cw: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const apply_rotate_180: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const apply_rotate_270_cw: (a: number, b: number, c: number, d: number) => [number, number, number, number];
