...
export interface InitOutput {
  ...
  readonly apply_brightness: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
  readonly apply_flip_horizontal: (a: number, b: number, c: number, d: number) => [number, number, number, number];
  readonly apply_flip_vertical: (a: number, b: number, c: number, d: number) => [number, number, number, number];
  readonly apply_rotate_90_cw: (a: number, b: number, c: number, d: number) => [number, number, number, number];
  readonly apply_rotate_180: (a: number, b: number, c: number, d: number) => [number, number, number, number];
  readonly apply_rotate_270_cw: (a: number, b: number, c: number, d: number) => [number, number, number, number];
